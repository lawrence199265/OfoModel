...
public class LinearLayoutListItemView extends LinearLayout implements OnClickListener {
    ...
    // 右侧图标(字体文件)
    private TextView mIv_RightIconText;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View viewRoot = LayoutInflater.from(mContext).inflate(R.layout.view_linear_list_item, null);
        ...
        mIv_RightIconText = (TextView) viewRoot.findViewById(R.id.mIv_RightIconText);
...
//		mList_Item_Image_Size = DisplayMetrics.dip2px(mContext, array.getInt(R.styleable.LinearLayoutListItemViewStyle_list_item_image_size, -1));
        ...
        if (mView_Body != null && mList_Item_Height != -1) {
            ...
            params.height = DensityUtils.dip2px(getContext(), mList_Item_Height);
        ...
        if (mIv_LeftIcon != null && mList_Item_Image_Size != -1) {
            ...
            params.width = DensityUtils.dip2px(getContext(), mList_Item_Image_Size);
            params.height = DensityUtils.dip2px(getContext(), mList_Item_Image_Size);
     ...
     * 设置显示样式
     *
     * @param style 参见：LIST_ITEM_STYLE_LISTITEM_TEXT | LIST_ITEM_STYLE_LISTITEM_MENU
     */
        ...
        switch (mListItem_Style) {
            case LIST_ITEM_STYLE_LISTITEM_TEXT:
                ...
                if (mTv_LeftText != null) {
                    ...
                    if (mLeftText_MarginLeft != -1) {
                        ...
                        params.setMargins(DensityUtils.dip2px(getContext(), mLeftText_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);
                        mTv_LeftText.setLayoutParams(params);
                    }
                    if (mLeftText_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
                        params.setMargins(params.leftMargin, params.topMargin, DensityUtils.dip2px(getContext(), mLeftText_MarginRight), params.bottomMargin);
                        mTv_LeftText.setLayoutParams(params);
                    }
                }
                ...
                if (mTv_LeftText2 != null) {
                    ...
                    if (mLeft2Text_MarginLeft != -1) {
                        ...
                        params.setMargins(DensityUtils.dip2px(getContext(), mLeft2Text_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);
                        mTv_LeftText2.setLayoutParams(params);
                    }
                    if (mLeft2Text_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText2.getLayoutParams();
                        params.setMargins(params.leftMargin, params.topMargin, DensityUtils.dip2px(getContext(), mLeft2Text_MarginRight), params.bottomMargin);
                        mTv_LeftText2.setLayoutParams(params);
                    }
                ...
                if (mTv_RightText != null) {
                    ...
                    if (mRightTextBackground != null) {
                        int intPadding1 = DensityUtils.dip2px(getContext(), 12);
                        int intPadding2 = DensityUtils.dip2px(getContext(), 8);
                    ...
                    if (mRightText_MarginRight != -1) {
                        ...
                        params.setMargins(params.leftMargin, params.topMargin, DensityUtils.dip2px(getContext(), mRightText_MarginRight), params.bottomMargin);
                        mTv_RightText.setLayoutParams(params);
                    }
                    if (mRightText_MarginLeft != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_RightText.getLayoutParams();
                        params.setMargins(DensityUtils.dip2px(getContext(), mRightText_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);
                        mTv_RightText.setLayoutParams(params);
                    }
            ...
            case LIST_ITEM_STYLE_LISTITEM_MENU:
                ...
                if (mTv_LeftText != null) {
                    ...
                    if (mLeftText_MarginLeft != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
                        params.setMargins(DensityUtils.dip2px(getContext(), mLeftText_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);// 通过自定义坐标来放置你的控件
                        mTv_LeftText.setLayoutParams(params);
                    }
                    if (mLeftText_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
                ...
                if (mTv_RightText != null) {
                    ...
                    if (mRightText_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_RightText.getLayoutParams();
                        params.setMargins(params.leftMargin, params.topMargin, DensityUtils.dip2px(getContext(), mRightText_MarginRight), params.bottomMargin);// 通过自定义坐标来放置你的控件
                        mTv_RightText.setLayoutParams(params);
                    }
    ...
    public void setLeftIconSize(int size) {
        if (mIv_LeftIcon != null && size != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mIv_LeftIcon.getLayoutParams();
            params.width = DensityUtils.dip2px(getContext(), size);
            params.height = DensityUtils.dip2px(getContext(), size);
            mIv_LeftIcon.setLayoutParams(params);
        }
    }
...
//		}
    ...
    public void setLeftText_MarginLeft(int value) {
        if (value != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
            params.setMargins(DensityUtils.dip2px(getContext(), value), params.topMargin, params.rightMargin, params.bottomMargin);// 通过自定义坐标来放置你的控件
            mTv_LeftText.setLayoutParams(params);
        }
    }
    ...
    public void setLeftText_MarginRight(int value) {
        if (value != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
            params.setMargins(params.leftMargin, params.topMargin, DensityUtils.dip2px(getContext(), value), params.bottomMargin);// 通过自定义坐标来放置你的控件
            mTv_LeftText.setLayoutParams(params);
        }
    }
