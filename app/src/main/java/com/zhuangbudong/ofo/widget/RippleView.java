...
public class RippleView extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, getResources().getColor(R.color.color_ripple_gray));
        rippleType = typedArray.getInt(R.styleable.RippleView_rv_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.RippleView_rv_zoom, false);
        isCentered = typedArray.getBoolean(R.styleable.RippleView_rv_centered, false);
        mEnableRipple = typedArray.getBoolean(R.styleable.RippleView_rv_enable_ripple, true);
        DURATION = typedArray.getInteger(R.styleable.RippleView_rv_ripple_duration, DURATION);
        FRAME_RATE = typedArray.getInteger(R.styleable.RippleView_rv_frame_rate, FRAME_RATE);
